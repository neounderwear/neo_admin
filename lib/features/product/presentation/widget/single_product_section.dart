...
class SingleProductSection extends StatefulWidget {
  const SingleProductSection({super.key});

  @override
  State<SingleProductSection> createState() => _SingleProductSectionState();
}

class _SingleProductSectionState extends State<SingleProductSection> {
  @override
