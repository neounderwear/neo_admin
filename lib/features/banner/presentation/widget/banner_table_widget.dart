...
import 'package:neo_admin/features/banner/presentation/widget/update_banner_widget.dart';
        ...
        rows: <DataRow>[
          DataRow(
            cells: <DataCell>[
              ...
              DataCell(Center(child: Text('Home'))),
              ...
              DataCell(
                Center(
                  child: Row(
                    ...
                    children: [
                      IconButton(
                        icon: Icon(IconlyBold.edit, size: 18),
                        onPressed: () {
                          showDialog(
                            barrierDismissible: false,
                            context: context,
                            builder: (context) => UpdateBannerWidget(),
                          );
                        },
                      ),
                      IconButton(
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: const Text(
                                    'Banner bakalan dihapus permanen'),
                                actions: [
                                  TextButton(
